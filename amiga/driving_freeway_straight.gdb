...
break vbiHandler if s_drivingFrameStarted && *(unsigned short*)(*(unsigned int*)(s_currentA5-0x3678)+0x3e) >= 6 && *(unsigned short*)(*(unsigned int*)(s_currentA5-0x3678)+0x40) == 36 && *(signed short*)(s_currentA5-0x3764) == 1
commands
  silent
  set $straight_hit = 1

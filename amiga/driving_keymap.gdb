...
# vette_user_vbl_trampoline+30 is the instruction after JSR (A1).
break *vette_user_vbl_trampoline+30 if *(unsigned short*)(s_currentA5+26) != 0 && (*(short*)(s_currentA5-20464) != 0 || *(short*)(s_currentA5-20462) != 0)
commands
  silent

...
dump binary memory ../tmp/amiga_intro.planes s_loudStopScreen->m_back s_loudStopScreen->m_back+81920
...
continue
finish
dump binary memory ../tmp/amiga_intro.front s_loudStopScreen->m_chip s_loudStopScreen->m_chip+81920
dump binary memory ../tmp/amiga_intro.copper_colors s_loudStopScreen->m_copper+8 s_loudStopScreen->m_copper+24
printf "captured 512x320 intro framebuffer at Stage C depth %u\n", g_stageCDepth
detach
quit

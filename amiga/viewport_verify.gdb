...
if $mouseFailures == 0 && !s_screen->m_mouseAllowed && $seen == 7 && g_stageBState != 3 && g_macDrivingIterations >= 4 && s_screen->m_cropLeft == 80 && s_screen->m_cropTop == 0 && g_c2pVerifyFailures == 0 && g_fillBadPixels == 0
